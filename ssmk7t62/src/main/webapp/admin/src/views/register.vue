  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 215, 0, 0.02);borderRadius:20px">
        <h1 class="h1" style="color:rgba(255, 69, 0, 1);fontSize:30px;">设备故障报修管理系统小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='weixiuyuan'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            if(`weixiuyuan` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
