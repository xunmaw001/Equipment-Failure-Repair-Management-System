  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="设备名称" prop="shebeimingcheng">
              <el-input v-model="ruleForm.shebeimingcheng" 
                placeholder="设备名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="使用状态" prop="shiyongzhuangtai">
          <el-select v-model="ruleForm.shiyongzhuangtai" placeholder="请选择使用状态">
            <el-option
                v-for="(item,index) in shiyongzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="使用状态" prop="shiyongzhuangtai">
	      <el-input v-model="ruleForm.shiyongzhuangtai"
                placeholder="使用状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="实验室详情" prop="shiyanshixiangqing">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shiyanshixiangqing" label="实验室详情" prop="shiyanshixiangqing">
                    <span>{{ruleForm.shiyanshixiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
