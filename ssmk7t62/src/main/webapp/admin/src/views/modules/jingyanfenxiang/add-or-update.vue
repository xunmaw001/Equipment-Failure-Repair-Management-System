              ...
              <div v-else>
                <el-form-item v-if="ruleForm.sunhuaiyuanyin" label="损坏原因" prop="sunhuaiyuanyin">
                    <span>{{ruleForm.sunhuaiyuanyin}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="维修方法" prop="weixiufangfa">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="维修方法"
                  v-model="ruleForm.weixiufangfa" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.weixiufangfa" label="维修方法" prop="weixiufangfa">
                    <span>{{ruleForm.weixiufangfa}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jingyanfenxiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jingyanfenxiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
